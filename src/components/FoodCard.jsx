...
function FoodCard({name, brand, category, image}) {
  return (
    <div className='food-container relative'>
      ...
      <div className='h-full w-full flex flex-col bg-gray-500 rounded-lg absolute bottom-0 left-0 text-center justify-center opacity-95'>
